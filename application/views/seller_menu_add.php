...
<div class="row">
    ...
    <div class="card">
        ...
        <div class="row mb-3">
            ...
            <div class="col-sm-10">
                <input type="text" class="form-control" id="nama_menu" name="nama_menu" value="<?= set_value('nama_menu') ?>" autocomplete="off">
            </div>
        </div>
        <div class="row mb-3">
            <label for="harga" class="col-sm-2 col-form-label">Harga</label>
            <div class="col-sm-10">
                <input type="text" class="form-control" id="harga" name="harga" value="<?= set_value('harga') ?>" autocomplete="off">
            </div>
        </div>
        <div class="row mb-3">
            <label for="deskripsi_menu" class="col-sm-2 col-form-label">Deskripsi</label>
            <div class="col-sm-10">
                <input type="text" class="form-control" id="deskripsi_menu" name="deskripsi_menu" value="<?= set_value('deskripsi_menu') ?>" autocomplete="off">
            </div>
        </div>
        <div class="row mb-3">
            ...
            <div class="col-sm-10">
                <select name="category_id" class="form-select" aria-label="Default select example">
                    <option selected value="">Pilih kategori menu</option>
        ...
        <div class="row mb-3">
            ...
            <button class="btn btn-success" type="submit">Tambah Menu</button>
        </form>
        </div>
    </div>
    </div>
